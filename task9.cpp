...
void get_better_opt(int n) {
    ...
    printf("BETTER Options count:\nSTATIC: %d\nDYNAMIC: %d\nGUIDED: %d\nRUNTIME: %d\nNONPARALLEL: %d\n",
           better_opt_cout[STATIC - 1], better_opt_cout[DYNAMIC - 1], better_opt_cout[GUIDED - 1],
           better_opt_cout[RUNTIME - 1], better_opt_cout[NONPARALLEL - 1]);
...
int main() {
    ...
    for (int matrix_size = MATRIX_STEP; matrix_size < MATRIX_SIZE; matrix_size += MATRIX_STEP) {
        get_better_opt(matrix_size);
    }
